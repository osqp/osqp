...
Precompiled platform-dependent Matlab binaries are available on `Github <https://github.com/oxfordcontrol/osqp/releases/tag/v0.1.3>`_.

To install the interface, just run the following commands:

.. code:: matlab

    websave('install_osqp.m', 'https://github.com/oxfordcontrol/osqp/releases/download/v0.1.3/install_osqp.m');
    install_osqp
