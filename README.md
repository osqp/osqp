...
[![Build status of the master branch on Windows](https://img.shields.io/appveyor/ci/bstellato/osqp.svg?label=Windows%20build)](https://ci.appveyor.com/project/bstellato/osqp/branch/master)
