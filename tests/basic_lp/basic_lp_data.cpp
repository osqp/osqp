...
OSQPTestData * generate_problem_basic_lp(){
...
data->q[0] = 1.10000000000000008882;
data->q[1] = 0.94999999999999995559;
...
void clean_problem_basic_lp(OSQPTestData * data){
...
basic_lp_sols_data *  generate_problem_basic_lp_sols_data(){

basic_lp_sols_data * data = (basic_lp_sols_data *)c_malloc(sizeof(basic_lp_sols_data));
...
data->y_test[0] = -1.10000000000000008882;
data->y_test[1] = 0.00000000000000000000;
data->y_test[2] = 0.14999999999999999445;
data->y_test[3] = 0.00000000000000000000;

data->obj_value_test = 0.99499999999999999556;
...
void clean_problem_basic_lp_sols_data(basic_lp_sols_data * data){
