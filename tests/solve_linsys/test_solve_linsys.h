...
static char* test_solveKKT() {
  ...
  p = osqp_init_linsys_solver_(data->test_solve_KKT_Pu, data->test_solve_KKT_A,
  ...
  // print_dns_matrix(KKTdnspy, data->test_solve_KKT_KKT->m,
  // data->test_solve_KKT_KKT->n, "KKTdnspy");
...
static char* test_solveKKT_pardiso() {
  ...
  exitflag = osqp_load_linsys_solver_(MKL_PARDISO_SOLVER);
  ...
  exitflag = osqp_unload_linsys_solver_(MKL_PARDISO_SOLVER);
