...
test_solve_KKT_KKT = sparse.bmat([
                        [test_solve_KKT_P + test_solve_KKT_sigma * sparse.eye(test_solve_KKT_n), test_solve_KKT_A.T],
                        [test_solve_KKT_A, -1./test_solve_KKT_rho * sparse.eye(test_solve_KKT_m)]], format='csc')
