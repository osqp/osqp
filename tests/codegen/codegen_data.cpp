...
OSQPTestData * generate_problem_codegen(){
...
void clean_problem_codegen(OSQPTestData * data){
...
codegen_sols_data *  generate_problem_codegen_sols_data(){

codegen_sols_data * data = (codegen_sols_data *)c_malloc(sizeof(codegen_sols_data));
...
void clean_problem_codegen_sols_data(codegen_sols_data * data){
