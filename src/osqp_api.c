...
c_int osqp_codegen(OSQPSolver *solver,
  ...
  char fname[50], hfname[50], cfname[50], incGuard[50];
  FILE *incFile, *srcFile;
  time_t now;
  c_int i = 0;
  ...
  write_header_inc(incfile);
  write_header_src(srcfile);
  ...
  /* Include types and linsys_solver header */
  ...
  write_settings_inc(incFile, solver);
  write_settings_src(srcFile, solver);
