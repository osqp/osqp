...
def run_mpc_pendulum_example():
    ...
    utils.generate_plot('mpc_pendulum', 'time', 'median', N_vec, solver_timings,
                        fig_size=0.9)
    utils.generate_plot('mpc_pendulum', 'time', 'total', N_vec, solver_timings,
                        fig_size=0.9)
    utils.generate_plot('mpc_pendulum', 'time', 'max', N_vec, solver_timings,
                        fig_size=0.9)
